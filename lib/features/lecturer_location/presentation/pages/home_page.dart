...
import '../widgets/drag_detector.dart';
        ...
        child: DragDetector(
          ...
          child: CustomScrollView(
            ...
            slivers: [
                  ...
                  title: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Image.asset('assets/images/icon-full.png',
              ...
              SliverToBoxAdapter(
                child:
                    BlocListener<LecturerLocationBloc, LecturerLocationState>(
                  ...
                  listener: (context, state) {
                    if (state is LecturerLocationError) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: const Text('Lokasi tidak berubah...'),
                          ...
                          children: [
                            Container(
                              ...
                              child: BlocProvider<MapCubit>(
                                create: (_) => di.sl<MapCubit>(),
                                child: LocationMapWidget(
                                        location: location.location)
                                    .animate()
                                    .fadeIn(
                                        duration: 950.ms, curve: Curves.easeOut)
                                    .slideY(
                                        begin: 0.05, end: 0, duration: 1000.ms),
                              ),
                            ),
